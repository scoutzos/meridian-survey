...
OUT = ROOT / "contracts" / "meridian-va-independent-contractor-agreement.pdf"
...
def build():
    ...
    meta = Table(
        [
            [field("Effective Date"), field("Company", "Meridian Collective Group")],
            [field("Company Representative"), field("Contractor Name")],
            [field("Contractor Email"), field("Phone / WhatsApp")],
        ],
