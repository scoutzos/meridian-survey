...
def build():
    ...
    story.extend(section("3. Advance Against Final Pay", "Company agrees to advance Contractor one (1) week of pay at the beginning of the engagement in the amount of $135.", "This advance is not a bonus. It is an advance against Contractor's final payout. Upon termination, resignation, or completion of the engagement, Company may deduct the advance from any final amounts owed to Contractor.", "If Contractor's final approved pay is less than the advance amount, Contractor agrees to repay the remaining balance within seven (7) days of written request."))
